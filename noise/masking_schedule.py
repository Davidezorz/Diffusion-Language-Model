...
class Masking:
    ...
    def __init__(self, T: int, noise: Noise, corruption_type: str, 
    ...
    def __call__(self, *args, **kwds):
        return self.corruption_types[self._corruption_type](*args, **kwds)
    ...
    def position_dependent_masking(self, t):
    ...
    def moving_sigmoid_masking(self, t):
